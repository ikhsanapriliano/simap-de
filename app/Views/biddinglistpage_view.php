...
<body id="page-top">
    <div id="wrapper">
        <!-- success modal -->
        <?php if (!empty(session()->getFlashdata('insertSuccess'))): ?>
        <div class="modal fade" tabindex="-1" role="dialog" id="insertModal">
            <div class="modal-dialog" role="document">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Action Success! </strong><?=  session()->getFlashdata('insertSuccess') ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Bidding List</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./dashboard">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Bidding List</li>
                        </ol>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div
                                    ...
                                    <a href="/addbidd" class="btn btn-primary"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <section class="d-flex">
                                                        <a href="/editspk-<?= $item['spk_id'] ?>">
                                                            <button title="edit spk" type="submit"
                                                                class="btn btn-warning mr-1"><i
                                                                    class="fa fa-paint-brush"></i></button>
                                                        </a>
                                                        <form action="add-to-order-<?= $item['pekerjaan_id'] ?>"
                                                            method="post">
                                                            <input type="hidden" name="_method" value="PATCH" />
                                                            <button title="tambahkan ke orderlist" type="submit"
