    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <!-- Topbar -->
                <!-- Container Fluid-->
                <div class="container-fluid" style="overflow: hidden; height: 500px;" id="container-wrapper">
                    <link
                    ...
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        x="0px" y="0px" viewBox="0 0 306.8 404.9" style="enable-background:new 0 0 306.8 404.9;"
                        xml:space="preserve">
                        ...
                        <g>
                            ...
                            <g class="st0">
                                ...
                                c5.5,0,10,4,10,8.9V262.4z" />
                                    ...
                                    <text transform="matrix(1 0 0 1 85.4612 263.0171)" class="st9 st20 st21">404
                                        error</text>
                                </g>
                                <rect x="44.7" y="322.3" class="st22" width="212.1" height="34.4" />
                                <text transform="matrix(1 0 0 1 47.2058 329.1734)" class="st4">
                                    <tspan x="0" y="0" class="st23 st24 st25">Lorem ipsum dolor sit amet, consectetur
                                        adipiscing </tspan>
                              ...
                              c4.3,0,7.8,3.5,7.8,7.8V301.4z" />
                                    ...
                                    <text transform="matrix(1 0 0 1 45.1999 303.7364)" class="st9 st26 st27">sorry, the
                                        page not found</text>
                                </g>
                        ...
                        <g>
                            ...
                            <text opacity="0.6" x="15" y="257" fill="#000" font-family="Viga" font-size="25">There is no
                                way Immma
                    ...
                    // Bar Chart Workers
                    const barLabels1 = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'];
                    const barData1 = {
                        labels: barLabels1,
                        datasets: [{
                            label: 'Data Workers',
