        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <section>
                        <form action="/editfilestorage-<?= $data['id'] ?>" method="post" enctype="multipart/form-data">
                            <div class="file">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="preview-zone hidden">
                                                <div class="box box-solid">
                                                    <div class="box-header with-border">
                                                        ...
                                                        <embed class="mt-3" id="pdf-preview"
                                                            src="aset/storage/pdf/<?= $data['file_pdf'] ?>"
                                                            type="application/pdf"
                                                            <?= !empty($data['file_pdf']) ? '' : 'hidden' ?> />
                                                    </div>
                                                    <div class="box-body">
                                                        <?php if (!empty($data['file_pdf'])): ?>
                                                        <p><?= explode('-f&f-', $data['file_pdf'])[1]?></p>
                                                        <?php endif ?>
                                            ...
                                            <div class="dropzone-wrapper">
                                                ...
                                                <?php if (!empty($data['file_pdf'])): ?>
                                                <input type="hidden" id="deleted-pdf" name="deleted-pdf"
                                                    value="false" />
                                                <?php endif ?>
                                                <input id="pdf-input" type="file" name="pdf" class="dropzone"
                                                    accept="application/pdf" value="<?= $data['file_pdf'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="preview-zone hidden">
                                                <div class="box box-solid">
                                                    ...
                                                    <div class="box-body">
                                                        <?php if (!empty($data['file_zip'])): ?>
                                                        <p><?= explode('-f&f-', $data['file_zip'])[1] ?></p>
                                                        <?php endif ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="dropzone-wrapper">
                                                ...
                                                <?php if (!empty($data['file_zip'])): ?>
                                                <input type="hidden" id="deleted-zip" name="deleted-zip"
                                                    value="false" />
                                                <?php endif ?>
                                                <input type="file" name="zip" class="dropzone"
                                                    accept="application/zip,.rar" value="<?= $data['file_zip'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <center>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="no_registrasi"
                                            placeholder="Type Here" required value="<?= $data['no_registrasi'] ?>">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label>Pemesan</label>
                                        <input required type="text" class="form-control" name="pemesan"
                                            placeholder="Type Here" value="<?= $data['pemesan'] ?>">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label>Nama Pekerjaan</label>
                                        <input required type="text" class="form-control" name="pekerjaan"
                                            placeholder="Type Here" value="<?= $data['pekerjaan'] ?>">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
